                        ...
                        <div class="col-md-4 my-3">
                            <div class="card card-user">
                                <div class="card-body">
                                    <p class="card-text">
                                    <div class="author">
                                        <h5 class="title mx-3 text-center"><b>Datos de la cita</b></h5>
                                        </a>
                                        <p class="description">
                                            ...
                                            <b>Nota:</b> El valor total puede cambiar porque algunos medicamentos no
                                            vienen incluidos en el
                                            servicio.
                                        </p>
                                    </div>
                                    </p>
                            ...
                            <br>
                            @if ($mascota->estado == 'Aceptada')
                            <div class="h2 texto color-verde">
                                Estado: {{ $mascota->estado }}
                            </div>
                            @else
                            <div class="h2 texto color-rojo">
                                Estado: {{ $mascota->estado }}
                            </div>
                            <a href="{{ route('citas.create') }}" class="btn btn-success">Solicitar cita</a>
                            @endif
                        </div>
                    </div>
                </div>
